...
//	void New();
	...
	void PolygonPaste();                        //Paste Polygon region to object image
	void Possion();                             //simple possion image editing
	void Mix_Possion();                         //mix possion method
	void Possion_Paste();                       //moving together with possion
...
//	QAction						*action_new_;
	...
	QAction                     *action_Polygon_paste_;
	//about possion editing
	QAction                     *action_possion_;
	QAction                     *action_mix_possion_;
	QAction                     *action_possion_paste_;
